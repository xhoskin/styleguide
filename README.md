...
### 4.4. Пишите медиа-запросы с max-width перед запросами с min-width.

Запросы с max-width нужны и полезны, когда стили телефонов не должны переползать
на большие экраны. Например, кнопка меню с бутербродной иконкой. Или прятанье 
длинных подразделов под аккордеоны, как на мобильной Википедии.
