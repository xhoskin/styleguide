...
[comment]: <> (TODO: расставить верную нумерацию (ищи /\.x/g ))
...
В большинстве случаев из названия и так понятен его тип. 
[comment]: <> (Однако будет полезно [почитать о БЭМ-префиксах](TODO:ссылка))
...
Однако пишите полностью название блока и модификатор, когда 
[comment]: <> ([описываете отдельное большое состояние](TODO:#ссылка_на_такое_правило).)
